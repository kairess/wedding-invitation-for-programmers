      ...
      <div class="invitation-cover">
        <div class="cover-content" :class="{'invitation-up':isOpening}">
          <div class="content-inside">
            ...
            <p>우리 결혼합니다！</p>
            <p>
              이세원 · 김자은 의 장남 <b>이태희</b><br>
              이윤주 · 김미정 의 장녀 <b>이희수</b>
            </p>
            <p>
              시간：2021년 5월 8일 오후 2시<br>
              장소：<b>용산가족공원 연못광장</b>
            </p>

            <p style="font-size: 12px;">코로나 19로 인해 예식 참석 인원에 제한이 있습니다. 축하해주신 여러분들을 모두 초대하지 못하는 점 깊은 양해 부탁드립니다.</p>
